...
class illumoraeTextToFilenameSafeTextNode:
    """
    ...
    CATEGORY = "illumorae"
    DESCRIPTION = "Converts text into a filename-safe string (Windows-safe) with normalization, character filtering, and length truncation."
    ...
    def process_string(self, string_in, max_length=150):
        ...
        string_in = self.remove_bad_filename_chars(string_in)
...
# Register the node
NODE_CLASS_MAPPINGS = {
    "illumoraeTextToFilenameSafeTextNode": illumoraeTextToFilenameSafeTextNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "illumoraeTextToFilenameSafeTextNode": "Text To Filename Safe Text",
}
